...
const resources = {
  'zh-CN': {
    translation: {
      ...
      feature1Title: '画像与标签',
      feature1Text: '学生选择主动标签，系统结合互动和任务表现生成综合画像。',
      feature2Title: '预沟通确认',
      feature2Text: '候选小组先沟通角色和任务偏好，确认后再成为正式团队。',
      feature3Title: '任务调优',
      feature3Text: '一周后根据进度、反馈、活跃度和负载生成可解释调优建议。',
      feature4Title: '教学看板',
      feature4Text: '老师查看完成率、积极性、风险、反馈和导出数据，支撑督促与评分。',
  ...
  en: {
    translation: {
      ...
      feature1Title: 'Profiles and tags',
