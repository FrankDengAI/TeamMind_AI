...
const resources = {
  'zh-CN': {
    translation: {
      ...
      student: '我是学生',
      studentText: '进入学生端，使用邮箱验证码注册/登录，填写画像、参与组队、确认角色、提交任务和反馈。',
      enterTeacher: '进入教师端',
      enterStudent: '进入学生端',
  ...
  en: {
    translation: {
      ...
      student: 'Student',
      studentText: 'Open the student app to sign up or log in with email verification, then complete profiles, teams, roles, and tasks.',
